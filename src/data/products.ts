...
export const categories: Category[] = [
    ...
    },
    {
        slug: 'knitwear',
        name: 'Knitwear',
        description: 'Soft knitwear pieces woven with care, offering warmth, comfort, and timeless appeal.',
        image: '/knitwear.png',
        productCount: 5,
    },
    {
        slug: 'shawls',
        name: 'Shawls & Wraps',
        description: 'Exquisite shawls and wraps crafted in timeless, reflecting tradition, warmth, and elegance.',
        image: '/shawls.png',
        productCount: 4,
    },
    {
        slug: 'accessories',
        name: 'Accessories',
        description: 'Refined winter accessories designed with detail, offering warmth, function, and subtle sophistication.',
    ...
    },
    {
        slug: 'cosmetics',
        name: 'Cosmetics',
        description: 'Pure, nature-inspired essentials sourced with care, reflecting authenticity, richness, and Himalayan origins.',
        image: '/cosmetics.png',
        productCount: 4,
    },
    {
