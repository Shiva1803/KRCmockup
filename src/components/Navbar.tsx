...
export default function Navbar() {
    ...
    return (
        ...
        >
            <nav className="bg-white backdrop-blur-md shadow-sm">
                ...
                >
                    <div className="px-6 pb-6 pt-2 space-y-1 bg-white border-t border-navy/10">
                        {navLinks.map((link) => (
                            <NavLink
                                key={link.to}
                                to={link.to}
                                ...
                                className={({ isActive }) =>
                                    `block py-3 text-sm tracking-widest uppercase transition-colors duration-300 ${isActive ? 'text-ochre' : 'text-navy/80 hover:text-ochre'
                                    }`
                                }
                            >
                                {link.label}
